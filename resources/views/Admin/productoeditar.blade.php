...
@section('content')
<form autocomplete="off" action="{{route('admin.productoupdate',$producto)}}" method="POST"
    ...
    <div class="container border border-success rounded py-4">
        ...
        <div class="form-group row mx-auto px-4 py-2">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" name="suplidor" value="{{$producto->suplidor}}"
        ...
        <div class="form-group row mx-auto px-4 py-2">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" name="categoria" value="{{$producto->categoria}}"
