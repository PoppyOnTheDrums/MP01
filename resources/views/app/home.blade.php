    ...
    <div class="facilities">
        ...
        <div class="row">
            <div class="facilities-col show-on-scroll" id="col1">
                ...
                <br>
                <br>
                Registrándote en la plataforma es la forma más rápida y sencilla de ser insertado en el mercado laboral.</p>
            </div>
            <div class="facilities-col show-on-scroll" id="col2">
                ...
                <br>
                <br>
                La pasantía es el primer paso para insertarte en el mercado laboral. Da seguimiento y ocúpate, eso te abre puertas al futuro.</p>
            </div>
            <div class="facilities-col show-on-scroll" id="col3">
                ...
                <br>
                Entra y aplica a las posiciones que se ajusten a tu perfil. La plataforma siempre estará disponible para que puedas entrar y dar seguimiento, actualizar tu perfil y estatus laboral, entre otros.</p>
            </div>
        </div>
    </div>
    <div class="cta">
...
Apoya a los jóvenes para que realicen pasantías en su empresa y disminuya la curva de aprendizaje de nuevos empleados, así lograremos ser más competitivos.</p>
        <a href="" class="botonreg">Registrate</a>
    <div>
